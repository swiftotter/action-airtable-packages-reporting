...
var eventTargetShim = __nccwpck_require__(7065);
...
if (!browserGlobal) {
    AbortController = __nccwpck_require__(3790);
}
    ...
    var polyfill = __nccwpck_require__(5140);
...
var base_1 = __importDefault(__nccwpck_require__(3160));
var record_1 = __importDefault(__nccwpck_require__(2238));
var table_1 = __importDefault(__nccwpck_require__(5484));
var airtable_error_1 = __importDefault(__nccwpck_require__(8878));
...
var get_1 = __importDefault(__nccwpck_require__(1169));
var isPlainObject_1 = __importDefault(__nccwpck_require__(2982));
var keys_1 = __importDefault(__nccwpck_require__(5390));
var fetch_1 = __importDefault(__nccwpck_require__(7861));
var abort_controller_1 = __importDefault(__nccwpck_require__(1997));
var object_to_query_param_string_1 = __importDefault(__nccwpck_require__(9548));
var airtable_error_1 = __importDefault(__nccwpck_require__(8878));
var table_1 = __importDefault(__nccwpck_require__(5484));
var http_headers_1 = __importDefault(__nccwpck_require__(6891));
var run_action_1 = __importDefault(__nccwpck_require__(6722));
var package_version_1 = __importDefault(__nccwpck_require__(1928));
var exponential_backoff_with_jitter_1 = __importDefault(__nccwpck_require__(6799));
...
// istanbul ignore file
var node_fetch_1 = __importDefault(__nccwpck_require__(1825));
var browserGlobal = typeof window !== 'undefined' ? window : typeof self !== 'undefined' ? self : null; // self is the global in web workers
...
var isArray_1 = __importDefault(__nccwpck_require__(5594));
var isNil_1 = __importDefault(__nccwpck_require__(7868));
var keys_1 = __importDefault(__nccwpck_require__(5390));
/* eslint-enable @typescript-eslint/no-explicit-any */
...
var isFunction_1 = __importDefault(__nccwpck_require__(9624));
var keys_1 = __importDefault(__nccwpck_require__(5390));
var record_1 = __importDefault(__nccwpck_require__(2238));
var callback_to_promise_1 = __importDefault(__nccwpck_require__(1108));
var has_1 = __importDefault(__nccwpck_require__(2397));
var query_params_1 = __nccwpck_require__(2553);
var object_to_query_param_string_1 = __importDefault(__nccwpck_require__(9548));
/**
...
var typecheck_1 = __importDefault(__nccwpck_require__(4191));
var isString_1 = __importDefault(__nccwpck_require__(3067));
var isNumber_1 = __importDefault(__nccwpck_require__(8396));
var isPlainObject_1 = __importDefault(__nccwpck_require__(2982));
var isBoolean_1 = __importDefault(__nccwpck_require__(689));
...
var isPlainObject_1 = __importDefault(__nccwpck_require__(2982));
var deprecate_1 = __importDefault(__nccwpck_require__(8545));
var query_1 = __importDefault(__nccwpck_require__(8720));
var query_params_1 = __nccwpck_require__(2553);
var object_to_query_param_string_1 = __importDefault(__nccwpck_require__(9548));
var record_1 = __importDefault(__nccwpck_require__(2238));
var callback_to_promise_1 = __importDefault(__nccwpck_require__(1108));
...
var baseTimes = __nccwpck_require__(6024),
    ...
    isArray = __nccwpck_require__(5594),
...
var isArray = __nccwpck_require__(5594),
...
var baseGetTag = __nccwpck_require__(9590),
    getPrototype = __nccwpck_require__(7084),
    isObjectLike = __nccwpck_require__(5278);
...
(() => {
/* harmony import */ var airtable__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(4315);
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(7147);
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(9935);
...
const project = _actions_core__WEBPACK_IMPORTED_MODULE_2__.getInput('project', {required: true});
const environment = _actions_core__WEBPACK_IMPORTED_MODULE_2__.getInput('environment', {required: true});
const composerFile = _actions_core__WEBPACK_IMPORTED_MODULE_2__.getInput('composer-file') ? _actions_core__WEBPACK_IMPORTED_MODULE_2__.getInput('composer-file') : 'composer.lock';

const chunkSize = 10;

const packagesBase = new airtable__WEBPACK_IMPORTED_MODULE_0__({apiKey: token}).base(base);
...
function insertComposerPackages(project, environment, composerPackages, dev = false) {
    ...
    console.debug('Adding '+ packagesToAdd.length + dev ? ' dev' : 0);
...
try {
    deleteProjectEnvironmentPackages(project, environment)
        .then(() => {
            ...
            fs__WEBPACK_IMPORTED_MODULE_1__.readFile(composerFile, 'utf8', (error, data) => {
                if (error) {
                    console.error(error);
                    return;
                }
